...
class ActivityReportService
{
    ...
    private function attendance(
        ...
        return ActivityAttendance::query()
            ->join(
                ...
                'activity_sessions.id',
                '=',
                'activity_attendances.activity_session_id'
            )
            ->whereBetween(
                'activity_sessions.session_date',
                [$from->format('Y-m-d'), $to->format('Y-m-d')]
    ...
    private function memberships(
        ...
        return ActivityMembership::query()
            ...
            ->when(
                $activityId !== null,
                fn ($query) => $query->where('activity_id', $activityId)
            )
            ->selectRaw(
                'activity_id,
    ...
    private function membershipPayments(
        Carbon $from,
        Carbon $to,
        ?int $activityId
    ): Collection {
    ...
    private function membershipRefunds(
        Carbon $from,
        Carbon $to,
        ?int $activityId
    ): Collection {
    ...
    private function usagePayments(
        Carbon $from,
        Carbon $to,
        ?int $activityId
    ): Collection {
